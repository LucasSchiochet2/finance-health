...
class ExerciseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $exercises = [
            ...
            // Peito (Variações)
            [
                'name' => 'Supino com Halteres (Reto)',
                'muscle_group' => 'Peito',
                'description' => 'Similar ao supino com barra, mas usando halteres para maior amplitude de movimento e equilíbrio unilateral.',
                'photo_url' => 'https://images.unsplash.com/photo-1541534741688-6078c6bfb5c5?q=80&w=2069&auto=format&fit=crop'
            ],
            [
                'name' => 'Dips (Paralelas) para Peito',
                'muscle_group' => 'Peito',
                'description' => 'Nas barras paralelas, incline o tronco para frente para focar a carga na parte inferior do peitoral.',
                'photo_url' => 'https://images.unsplash.com/photo-1571019614242-c5c5dee9f50b?q=80&w=2070&auto=format&fit=crop'
            ],
            ...
            [
                ...
                'muscle_group' => 'Costas',
                'description' => 'Puxada vertical na polia alta usando o acessório triângulo, focando na espessura das costas.',
                'photo_url' => 'https://images.unsplash.com/photo-1598289431512-b97b0917affc?q=80&w=2074&auto=format&fit=crop'
            ],
            [
                'name' => 'Lombar no Banco Romano',
                'muscle_group' => 'Costas',
                'description' => 'Posicione-se no banco inclinado e realize a hiperextensão do tronco para fortalecer os eretores da espinha.',
                'photo_url' => 'https://images.unsplash.com/photo-1584735935682-2fddb6ca980b?q=80&w=1974&auto=format&fit=crop'
            ],

            // Pernas (Foco em Glúteos e Isoladores)
            [
                'name' => 'Cadeira Adutora',
                'muscle_group' => 'Pernas',
                'description' => 'Sentado na máquina, feche as pernas contra a resistência para trabalhar a parte interna da coxa.',
                'photo_url' => 'https://images.unsplash.com/photo-1632168532981-d249f6eb2546?q=80&w=2070&auto=format&fit=crop'
            ],
            [
                'name' => 'Agachamento Búlgaro',
                'muscle_group' => 'Pernas',
                'description' => 'Um pé apoiado atrás em um banco, agache com a perna da frente. Altamente eficaz para glúteos e quadríceps.',
                'photo_url' => 'https://images.unsplash.com/photo-1574680178050-55c6a6a96e0a?q=80&w=2069&auto=format&fit=crop'
            ],
            [
                'name' => 'Glúteo Quatro Apoios',
                'muscle_group' => 'Pernas',
                'description' => 'No chão ou máquina, chute para trás e para cima mantendo o joelho flexionado ou estendido.',
                'photo_url' => 'https://images.unsplash.com/photo-1627483297929-37f416fec7cd?q=80&w=2070&auto=format&fit=crop'
            ],

            // Ombros (Estabilidade e Posterior)
            [
                'name' => 'Desenvolvimento Militar (Barra)',
                'muscle_group' => 'Ombros',
                'description' => 'Desenvolvimento em pé com barra, exige grande estabilidade do core e força nos deltoides.',
                'photo_url' => 'https://images.unsplash.com/photo-1532384748853-8f54a8f476e2?q=80&w=2070&auto=format&fit=crop'
            ],
            [
                'name' => 'Elevação Lateral na Polia',
                'muscle_group' => 'Ombros',
                'description' => 'Trabalho lateral de ombro usando o cabo para manter a tensão constante em toda a amplitude.',
                'photo_url' => 'https://images.unsplash.com/photo-1590227632906-81cf9df3ee85?q=80&w=2070&auto=format&fit=crop'
            ],
            ...
            [
                'name' => 'Rosca 21',
                'muscle_group' => 'Bíceps',
                'description' => 'Série de rosca direta dividida em 3 partes: 7 repetições curtas embaixo, 7 curtas em cima e 7 completas.',
                'photo_url' => 'https://images.unsplash.com/photo-1581009146145-b5ef050c2e1e?q=80&w=2070&auto=format&fit=crop'
            ],
            [
                'name' => 'Tríceps Coice (Kickback)',
                'muscle_group' => 'Tríceps',
                'description' => 'Tronco inclinado, estenda o braço para trás mantendo o cotovelo fixo ao lado do corpo.',
                'photo_url' => 'https://images.unsplash.com/photo-1583454110551-21f2fa2afe61?q=80&w=2070&auto=format&fit=crop'
            ],
            [
                'name' => 'Tríceps Corda',
                'muscle_group' => 'Tríceps',
                'description' => 'Na polia alta usando a corda, abra as mãos no final da extensão para maior contração lateral.',
                'photo_url' => 'https://images.unsplash.com/photo-1590227632626-6218d36eb788?q=80&w=2070&auto=format&fit=crop'
            ],
            [
                'name' => 'Rosca Concentrada com Halter',
                'muscle_group' => 'Bíceps',
                'description' => 'Sentado, braço apoiado na parte interna da coxa, realize a flexão focando no pico do bíceps.',
                'photo_url' => 'https://images.unsplash.com/photo-1581009146145-b5ef050c2e1e?q=80&w=2070&auto=format&fit=crop'
            ],

            // Core / Abdômen
            [
                'name' => 'Abdominal Roda (Ab Wheel)',
                'muscle_group' => 'Abdômen',
                'description' => 'Ajoelhado, deslize a roda para frente o máximo possível e retorne usando a força do core.',
                'photo_url' => 'https://images.unsplash.com/photo-1571019614242-c5c5dee9f50b?q=80&w=2070&auto=format&fit=crop'
            ],
            [
                'name' => 'Elevação de Pernas na Barra Fixa',
                'muscle_group' => 'Abdômen',
                'description' => 'Pendurado na barra, eleve as pernas (esticadas ou flexionadas) até a altura do quadril.',
                'photo_url' => 'https://images.unsplash.com/photo-1598971639058-211a7219488b?q=80&w=2070&auto=format&fit=crop'
            ],
            [
                'name' => 'Prancha Lateral',
                'muscle_group' => 'Abdômen',
                'description' => 'Apoie o antebraço lateralmente no chão e sustente o corpo reto. Foco nos oblíquos.',
            ...
            [
                ...
                'muscle_group' => 'Cardio',
                'description' => 'Posição de flexão, simule uma corrida trazendo os joelhos em direção ao peito alternadamente.',
                'photo_url' => 'https://images.unsplash.com/photo-1599058945522-28d584b6f0ff?q=80&w=2069&auto=format&fit=crop'
            ],
            [
                'name' => 'Polichinelos',
                'muscle_group' => 'Cardio',
                'description' => 'Salte abrindo pernas e braços simultaneamente. Exercício clássico de aquecimento.',
            ...
            [
                ...
                'muscle_group' => 'Cardio',
                'description' => 'Simulador de escada para alto gasto calórico e fortalecimento de pernas e glúteos.',
                'photo_url' => 'https://images.unsplash.com/photo-1576678927484-cc907957088c?q=80&w=2069&auto=format&fit=crop'
            ],
            [
                'name' => 'Remo Seco (Rowing Machine)',
                'muscle_group' => 'Cardio',
                'description' => 'Simula o movimento de remada, trabalhando costas, pernas e sistema cardiovascular.',
                'photo_url' => 'https://images.unsplash.com/photo-1534438327276-14e5300c3a48?q=80&w=2070&auto=format&fit=crop'
            ],
            // Panturrilhas
            [
            ...
            [
                ...
                'muscle_group' => 'Cardio',
                'description' => 'Corrida ou caminhada na esteira para condicionamento cardiovascular.',
                'photo_url' => 'https://images.unsplash.com/photo-1576678927484-cc907957088c?q=80&w=2069&auto=format&fit=crop'
            ],
            [
                'name' => 'Bicicleta Ergométrica',
                'muscle_group' => 'Cardio',
                'description' => 'Pedalada estacionária. Ajuste a carga conforme necessário.',
                'photo_url' => 'https://images.unsplash.com/photo-1517931524326-bdd55a541177?q=80&w=2070&auto=format&fit=crop'
            ],
            [
                'name' => 'Elíptico (Transport)',
                'muscle_group' => 'Cardio',
                'description' => 'Movimento de caminhada/corrida sem impacto nas articulações.',
                'photo_url' => 'https://images.unsplash.com/photo-1534438327276-14e5300c3a48?q=80&w=2070&auto=format&fit=crop'
            ],
            [
                'name' => 'Pular Corda',
                'muscle_group' => 'Cardio',
                'description' => 'Pule corda mantendo ritmo constante. Ótimo para queima calórica.',
                'photo_url' => 'https://images.unsplash.com/photo-1599058945522-28d584b6f0ff?q=80&w=2069&auto=format&fit=crop'
            ],
            [
                'name' => 'Burpees',
                'muscle_group' => 'Cardio', // Full body
                'description' => 'Agachamento, flexão e salto em sequência. Exercício metabólico intenso.',
                'photo_url' => 'https://images.unsplash.com/photo-1541534741688-6078c6bfb5c5?q=80&w=2069&auto=format&fit=crop'
            ],
        ];
